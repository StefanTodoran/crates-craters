// // BLUE THEME 🔵
// const blue_graphics = {
//   DOOR: require('./assets/blue_theme/door.png'),
//   KEY: require('./assets/blue_theme/key.png'),
//   CRATE: require('./assets/blue_theme/crate.png'),
...
//   ONE_WAY_LEFT: require('./assets/blue_theme/one_way_left.png'),
//   ONE_WAY_RIGHT: require('./assets/blue_theme/one_way_right.png'),
//   ONE_WAY_UP: require('./assets/blue_theme/one_way_up.png'),
//   ONE_WAY_DOWN: require('./assets/blue_theme/one_way_down.png'),
//   EXPLOSION: require('./assets/blue_theme/explosion.png'),
//   LITTLE_EXPLOSION: require('./assets/blue_theme/little_explosion.png'),
...
//   HELP_ICON: require('./assets/blue_theme/help_icon.png'),
//   THEME_ICON: require('./assets/blue_theme/theme_icon.png'),
//   NIGHT_MODE_ICON: require('./assets/blue_theme/night_icon.png'),
...
//   LEVEL_SELECT_BANNER: require('./assets/blue_theme/levels_banner.png'),
//   WIN_BANNER: require('./assets/blue_theme/win_banner.png'),
...
// // ORANGE THEME 🟠
// const orange_graphics = {
//   DOOR: require('./assets/orange_theme/door.png'),
//   KEY: require('./assets/orange_theme/key.png'),
//   CRATE: require('./assets/orange_theme/crate.png'),
...
//   ONE_WAY_LEFT: require('./assets/orange_theme/one_way_left.png'),
//   ONE_WAY_RIGHT: require('./assets/orange_theme/one_way_right.png'),
//   ONE_WAY_UP: require('./assets/orange_theme/one_way_up.png'),
//   ONE_WAY_DOWN: require('./assets/orange_theme/one_way_down.png'),
//   EXPLOSION: require('./assets/orange_theme/explosion.png'),
//   LITTLE_EXPLOSION: require('./assets/orange_theme/little_explosion.png'),
...
//   HELP_ICON: require('./assets/orange_theme/help_icon.png'),
//   THEME_ICON: require('./assets/orange_theme/theme_icon.png'),
//   NIGHT_MODE_ICON: require('./assets/orange_theme/night_icon.png'),
...
//   LEVEL_SELECT_BANNER: require('./assets/orange_theme/levels_banner.png'),
//   WIN_BANNER: require('./assets/orange_theme/win_banner.png'),
...
// // PURPLE THEME 🟣
// const purple_graphics = {
//   DOOR: require('./assets/purple_theme/door.png'),
//   KEY: require('./assets/purple_theme/key.png'),
//   CRATE: require('./assets/purple_theme/crate.png'),
...
//   ONE_WAY_LEFT: require('./assets/purple_theme/one_way_left.png'),
//   ONE_WAY_RIGHT: require('./assets/purple_theme/one_way_right.png'),
//   ONE_WAY_UP: require('./assets/purple_theme/one_way_up.png'),
//   ONE_WAY_DOWN: require('./assets/purple_theme/one_way_down.png'),
//   EXPLOSION: require('./assets/purple_theme/explosion.png'),
//   LITTLE_EXPLOSION: require('./assets/purple_theme/little_explosion.png'),
...
//   HELP_ICON: require('./assets/purple_theme/help_icon.png'),
//   THEME_ICON: require('./assets/purple_theme/theme_icon.png'),
//   NIGHT_MODE_ICON: require('./assets/purple_theme/night_icon.png'),
...
//   HOW_TO_BANNER: require('./assets/purple_theme/how_to_banner.png'),
//   LEVEL_SELECT_BANNER: require('./assets/purple_theme/levels_banner.png'),
//   WIN_BANNER: require('./assets/purple_theme/win_banner.png'),
...
// // GREEN THEME 🟢
// const green_graphics = {
//   DOOR: require('./assets/green_theme/door.png'),
//   KEY: require('./assets/green_theme/key.png'),
//   CRATE: require('./assets/green_theme/crate.png'),
...
//   ONE_WAY_LEFT: require('./assets/green_theme/one_way_left.png'),
//   ONE_WAY_RIGHT: require('./assets/green_theme/one_way_right.png'),
//   ONE_WAY_UP: require('./assets/green_theme/one_way_up.png'),
//   ONE_WAY_DOWN: require('./assets/green_theme/one_way_down.png'),
//   EXPLOSION: require('./assets/green_theme/explosion.png'),
//   LITTLE_EXPLOSION: require('./assets/green_theme/little_explosion.png'),
...
//   HELP_ICON: require('./assets/green_theme/help_icon.png'),
//   THEME_ICON: require('./assets/green_theme/theme_icon.png'),
//   NIGHT_MODE_ICON: require('./assets/green_theme/night_icon.png'),
//   HAMMER_ICON: require('./assets/green_theme/hammer_icon.png'),
//   WALL_ICON: require('./assets/green_theme/wall_icon.png'),
//   SAVE_ICON: require('./assets/green_theme/save_icon.png'),
...
//   HOW_TO_BANNER: require('./assets/green_theme/how_to_banner.png'),
//   LEVEL_SELECT_BANNER: require('./assets/green_theme/levels_banner.png'),
//   WIN_BANNER: require('./assets/green_theme/win_banner.png'),
...
const main_graphics = {
  ...
  HOME_OUTLINED_ICON: require('./assets/main_theme/home_outlined_icon.png'),
  HOME_FILLED_ICON: require('./assets/main_theme/home_filled_icon.png'),
  PLAY_OUTLINED_ICON: require('./assets/main_theme/play_outlined_icon.png'),
  PLAY_FILLED_ICON: require('./assets/main_theme/play_filled_icon.png'),
  SHARE_OUTLINED_ICON: require('./assets/main_theme/share_outlined_icon.png'),
  SHARE_FILLED_ICON: require('./assets/main_theme/share_filled_icon.png'),

  TITLE_BANNER: require('./assets/main_theme/banner.png'),
  ABOUT_BANNER: require('./assets/main_theme/about_banner.png'),
  HOW_TO_BANNER: require('./assets/main_theme/how_to_banner.png'),
  LEVEL_SELECT_BANNER: require('./assets/main_theme/levels_banner.png'),
  WIN_BANNER: require('./assets/main_theme/win_banner.png'),
  TOOLS_BANNER: require('./assets/main_theme/tools_banner.png'),
  OPTIONS_BANNER: require('./assets/main_theme/options_banner.png'),
  SETTINGS_BANNER: require('./assets/main_theme/settings_banner.png'),
  SHARE_BANNER: require('./assets/main_theme/share_banner.png'),
...
export let colors = main_colors;
export let graphics = main_graphics;

// CHANGING THEME
// let current = 2;
// const rotation = ["blue", "orange", "purple", "green", "main"];
// const colors_rotation = [blue_colors, orange_colors, purple_colors, green_colors, main_colors];
// const graphics_rotation = [blue_graphics, orange_graphics, purple_graphics, green_graphics, main_graphics];
